    ...
    <div className="">
            ...
            <div className="mb-4">
              ...
              <div className="flex">
                <input
                  ...
                  id="phoneNumber"
                  name="phoneNumber"
                  className="form-input rounded-md p-1 shadow-sm w-full mr-2"
      ...
      {step === 15 && (
        ...
        <form className="max-w-lg mx-auto p-4">
          {/* Previous Tenants */}
          <div className="mb-4">
            <label htmlFor="previousTenants" className="block text-textColor font-bold mb-2">
              Previous Tenants:
            </label>
            <input
              type="text"
          ...
          {/* Rental History */}
          <div className="mb-4">
            <label htmlFor="rentalHistory" className="block text-textColor font-bold mb-2">
              Rental History:
            </label>
            <textarea
              id="rentalHistory"
          ...
          {/* Notable Events */}
          <div className="mb-4">
            <label htmlFor="notableEvents" className="block text-textColor font-bold mb-2">
              Notable Events:
            </label>
            <textarea
              id="notableEvents"
